...
enum RoutineTheme {
    ...
    var backgroundColor: Color {
        ...
        case .evening: return Color.VanillaCream
    ...
    var cardBackground: Color {
        switch self {
        case .morning: return Color.Cream
        case .evening: return Color(red: 254/255, green: 245/255, blue: 230/255)
    ...
    var textColor: Color {
        switch self {
        case .morning, .evening: return Color.Clay
    ...
    var accentColor: Color {
        ...
        case .evening: return Color.Clay
    ...
    var subtleTextColor: Color {
        switch self {
        case .morning, .evening: return Color.Clay.opacity(0.6)
